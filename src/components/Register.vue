          ...
          <div class="bg-gray-50 p-7 rounded-lg">
            <div class="flex flex-col gap-x-8 gap-y-10">
              <div class="flex flex-col space-y-4 w-full">
                <label for="login" class="text-sm font-medium text-gray-600">Email</label>
                <input type="text" id="login" name="login" autocomplete="login" class="border border-gray-300 rounded outline-indigo-500 px-3 py-1.5">
              </div>
              <div class="flex flex-col space-y-4 w-full">
                <label for="password" class="text-sm font-medium text-gray-600">Password</label>
                <input type="password" id="password" name="password" autocomplete="password" class="border border-gray-300 rounded outline-indigo-500 px-3 py-1.5">
              </div>
            </div>
